...
public class Main {
    ...
    /*public static void main(String[] args) {
        ...
        main.java.com.opensds.jsonmodels.authtokensresponses.AuthTokenHolder authTokenHolder = httpHandler.getAuthToken(tokenHolder.getResponseHeaderSubjectToken());
